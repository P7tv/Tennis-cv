...
KNOWN_QUIRKS = [
    ...
    "⚠️ กิ่ง slice ของ B2 (`impact-5`) **ยังพิสูจน์ข้ามคนไม่ได้** — SL ในชุด label"
    " มาจากคนเดียว (11 stroke / 1 คน) ตอน Leave-One-Person-Out จึงวัดไม่ได้"
    " (accuracy SL ตกจาก 0.64 เหลือ 0.00) 4/5 fold ที่มี SL ใน train เลือก 5"
    " ตรงกัน — ต้องเก็บ SL จากผู้เล่นคนอื่นมายืนยัน",
